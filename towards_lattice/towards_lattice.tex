...
%
%
We use an order $P=15$ approximation and the utilized values $\alpha_{i}$ and $\beta_{i}$ can be found in \textbf{{\Huge INSERT TABLE REF}}. In order to state the full RHMC procedure we want to take  a closer look at the pseudofermionic contribution to the bosonic force
%
%
\begin{equation}
