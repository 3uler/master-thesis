...
%
%
and thereby follows that $\det\mathcal{O}_{\rm F} \in \mathbb{R}$. For the \names{Pfaffian} of $\mathcal{O}_{\rm F}$ to be non-negative we require that $\det \mathcal{O}_{\rm F}$ is positive and factorizable into two equivalent terms, so that
%
%
\begin{equation}
