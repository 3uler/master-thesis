...
In order to discretize the derived model we will proceed with a chapter on lattice techniques that is of utmost importance for the further continuation.
